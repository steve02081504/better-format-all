...
- **El formateador predeterminado** — los archivos pasan por *Format Document*, por lo que se usa el `editor.defaultFormatter` configurado. La extensión nunca elige silenciosamente el primer formateador por ti.
